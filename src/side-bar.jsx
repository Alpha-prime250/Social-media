const Sidebar = ({selectedtab,setSelectedtab}) => {
 ...
 <a href="/"
  ...
  <svg className="bi pe-none me-2"
   ...
   height="32"
    aria-hidden="true">
    <use xlinkHref="#bootstrap"></use></svg> <span className="fs-4">Sidebar</span> 
    </a>
     <hr></hr>
    <ul className="nav nav-pills flex-column mb-auto">
       ...
       onClick={()=>
        ...
        <a href="#"
         ...
         aria-current="page"> <svg className="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlinkHref="#home">
